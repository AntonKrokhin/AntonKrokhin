...
* **Methodologies:** Data Wrangling, Funnel Analysis, Seasonality & Trend Tracking, Operational Analytics
...
* **[Online Store Sales Analytics](https://github.com/AntonKrokhin/online-stores-sales-analytics)** | `SQL` `Python` `Tableau`
